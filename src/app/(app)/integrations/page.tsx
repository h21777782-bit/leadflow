...
import { listIntegrationCalls } from "@/server/queries";
...
export default async function IntegrationsPage() {
  ...
  const calls = await listIntegrationCalls();
  ...
  return (
    <>
      ...
      <div className="grid gap-6 px-8 py-6 xl:grid-cols-3">
        ...
        <Panel title="Recent integration calls" className="xl:col-span-2" flush>
          {calls.length === 0 ? (
